...
;;
20)
wget -q -O /usr/bin/swapram "https://raw.githubusercontent.com/rwrtx/swapram/main/swapram.sh" && chmod +x /usr/bin/swapram && swapram
;;
77)
wget https://raw.githubusercontent.com/rwrtx/Vergil/main2/addons/dns2.sh && chmod +x dns2.sh && ./dns2.sh
;;
88)
wget https://raw.githubusercontent.com/rwrtx/Vergil/main/Tunnel/udp.sh && bash udp.sh
;;
99)
